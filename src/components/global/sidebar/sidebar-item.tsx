  ...
  return (
    <li className=" cursor-pointer my-[5px]">
      <Link
        href={href}
        className={cn(
          "flex rounded-lg justify-between items-center group hover:bg-[#1D1D1D]",
          selected ? "bg-[#1D1D1D]" : ""
        )}
      >
        ...
        {notifications !== 0 && (
          <span
            className={cn(
              "font-medium  mr-1 transition-all group-hover:bg-[#111111] px-2 rounded-sm text-[#9D9D9D]",
              selected ? "bg-[#111111]" : "bg-[#1D1D1D]"
            )}
          >
            {notifications}
          </span>
